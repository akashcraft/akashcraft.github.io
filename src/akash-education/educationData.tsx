...
import img5 from "./../assets/img-education/Graduation Family Photo.jpg";
import img6 from "./../assets/img-education/University Medal for Academic Excellence.jpg";
import img7 from "./../assets/img-education/Dean's Award for Fall 2023 Work Term Oral Presentation.jpg";
import img8 from "./../assets/img-education/Innovasea Scholarship for Computer Engineering.jpg";
import img9 from "./../assets/img-education/Verafin Inc. Computer Engineering Scholarship - Akash Samanta.jpg";
...
export const images = [img, img2, img3, img4, img5, img6, img7, img8, img9];
export const scholarshipData = [
  {
    title: "University Medal for Academic Excellence",
    year: "Winter 2026",
  },
  {
    title: "PEGNL Academic Excellence Award",
    year: "Winter 2026",
  },
  {
...
export const munHeaderData: HeaderRowData = {
  ...
  statLabel: ["Graduated", "GPA"],
  statValue: ["2026", "4.0"],
  statSubLabel: ["From 2021", "Out of 4.0"],
};
...
export const dpsHeaderData: HeaderRowData = {
  ...
  statValue: ["2021", "97"],
  statSubLabel: ["From 2014", "Out of 100"],
};
