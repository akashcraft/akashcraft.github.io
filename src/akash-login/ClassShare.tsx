...
import { useClassSharing } from "./AuthHooks";
...
export default function ClassShare() {
  ...
  const { data, error, loading } = useClassSharing(uid);
  ...
  const chipData = useMemo(() => {
    ...
    if (data.university) {
      chips.push({
        ...
        icon: (
          <SchoolOutlined
            sx={{ color: "white !important", printColorAdjust: "revert" }}
          />
        ),
      });
    }
